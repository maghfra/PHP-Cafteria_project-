                    ...
                    <form action="" method="post" class="mt-3">
                        <div class="row">
                            ...
                            <div class="col-sm-2 mt-4">
                                    <button id="filter" type="submit" class="btn text-light w-50" >filter</button>
...
if (mysqli_num_rows($order_result) > 0) {
  ...
  while ($order_row = mysqli_fetch_assoc($order_result)) {
      ...
      echo "</button>";
      echo "</td>";
      echo "<td>" . $order_row['total_price'] . " EGP</td>";
      echo "</tr>";
       // Additional row for order details, initially hidden
       echo "<tr class='order-details' style='display: none;'>";
       echo "<td colspan='2'>";
...
if(mysqli_num_rows($product_result) > 0) {
  ...
  while ($row = mysqli_fetch_assoc($product_result)) {
      echo "<tr >"; // Add style attribute for white background
      echo "<td >" . $row['name'] . "</td>"; // Add style attribute for white background
      echo "<td >" . $row['price'] . "</td>"; // Add style attribute for white background
      // Assuming the image is stored in a folder named "images"
      echo "<td ><img src='./assests/images/" . $row['image'] . "' width='100' height='100'></td>";      echo "</tr>";
      echo "</tr>";
  }
  echo "</tbody>";
  echo "</table>";
